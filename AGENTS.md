# DevPad agent instructions

Project-specific skills live in `.ai/skills/` and are the canonical source of guidance for every AI coding agent working in this repository.
